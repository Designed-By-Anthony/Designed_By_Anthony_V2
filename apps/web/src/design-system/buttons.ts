...
const slateBtn =
	"btn relative inline-flex items-center justify-center gap-[0.45rem] px-[1.8rem] py-[0.96rem] rounded-full overflow-hidden cursor-pointer no-underline font-semibold leading-none text-brand-linen bg-brand-accent border border-transparent shadow-[0_12px_28px_-14px_rgba(91,124,153,0.45)] transition-[transform,box-shadow,background-color,border-color] duration-[300ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-px hover:bg-[#4a6278] hover:shadow-[0_16px_32px_-16px_rgba(91,124,153,0.38)] active:scale-[0.98] focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-[rgba(91,124,153,0.45)] focus-visible:outline-offset-[3px] disabled:opacity-[0.72] disabled:cursor-not-allowed";
...
export const btnPrimary = `${slateBtn} ${btnPrimarySans}`;

export const btnPrimaryBook = `${slateBtn} ${btnPrimarySans} motion-safe:animate-none`;

export const btnPrimaryAudit = `${slateBtn} ${btnSerif} [&.audit-submit-success]:!bg-[#15803d] [&.audit-submit-success]:!opacity-100 [&.audit-submit-success]:!cursor-default disabled:cursor-wait`;

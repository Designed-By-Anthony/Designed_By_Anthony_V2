...
const TAB =
  "bg-transparent border-0 p-0 text-inherit cursor-pointer pointer-events-auto inline-flex items-center justify-center gap-2 max-[1199px]:fixed max-[1199px]:inset-x-0 max-[1199px]:bottom-0 max-[1199px]:z-[2] max-[1199px]:min-h-11 max-[1199px]:w-full max-[1199px]:flex-row max-[1199px]:rounded-t-[0.85rem] max-[1199px]:py-[0.55rem] max-[1199px]:px-4 max-[1199px]:[padding-bottom:calc(0.55rem+env(safe-area-inset-bottom,0px))] max-[1199px]:bg-brand-linen max-[1199px]:border max-[1199px]:border-brand-border max-[1199px]:border-b-0 max-[1199px]:shadow-[0_-8px_32px_-18px_rgba(26,42,64,0.12)] max-[1199px]:text-brand-indigo min-[1200px]:absolute min-[1200px]:right-[-1.75rem] min-[1200px]:top-4 min-[1200px]:w-7 min-[1200px]:h-[5.25rem] min-[1200px]:flex-col min-[1200px]:gap-[0.3rem] min-[1200px]:rounded-l-none min-[1200px]:rounded-r-[0.65rem] min-[1200px]:bg-brand-accent min-[1200px]:border min-[1200px]:border-brand-accent min-[1200px]:border-l-0 min-[1200px]:text-brand-linen";

  ...
  return (
    ...
    >
      <div className="pointer-events-auto mx-auto max-w-[44rem] rounded-[1.4rem] border border-[rgba(26,42,64,0.12)] bg-[rgba(248,249,250,0.95)] [backdrop-filter:blur(20px)] [-webkit-backdrop-filter:blur(20px)] px-6 py-5 shadow-[0_-16px_48px_-20px_rgba(26,42,64,0.2)] transform-gpu will-change-transform">
        <p
          id="cookie-title"
          className="m-0 mb-2 text-base font-bold tracking-[-0.01em] text-[#1a2a40]"
        >
          Cookies and analytics
        </p>
        <p
          id="cookie-desc"
          className="m-0 mb-4 text-[0.875rem] leading-[1.6] text-[#333333] [&_a]:text-[#5b7c99] [&_a]:no-underline [&_a]:border-b [&_a]:border-[rgba(26,42,64,0.15)] [&_a]:transition-[border-color,color] [&_a]:duration-200 [&_a:hover]:border-[#5b7c99] [&_a:hover]:text-[#4a6278]"
        >

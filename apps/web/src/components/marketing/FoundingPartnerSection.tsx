      ...
      <div className="section-container relative z-[1]">
        <div className={HEADER}>
          ...
          <h2 id="founding-partner-heading">
            {FOUNDING_PARTNER_BUILD_SLOTS} complimentary custom builds for early client partners.
          </h2>
        ...
        <div className={PILLARS}>
          <article className={PILLAR_BASE}>
            ...
            <p className={PILLAR_LEDE}>
              Full custom website—strategy, design, and hand-built performance—not a page builder
              skin. Reserved for businesses that are the right fit and ready for a higher-trust
              digital presence.
            </p>
            <ul className={PILLAR_LIST}>
              <li>Built for trust, calls, and local search—not vanity slides</li>
              <li>
                Mobile-first engineering with strong Lighthouse scores — {ATELIER_ROME_LEGACY}
              </li>
          ...
          <article className={PILLAR_BASE}>
            ...
            <h3 className={PILLAR_TITLE}>
              <span className={PILLAR_PRICE}>{FOUNDING_PARTNER_SEO_MONTHLY}</span>
              /mo {FOUNDING_PARTNER_SEO_LABEL}
            </h3>
            <p className={PILLAR_LEDE}>
              Ongoing visibility and care: Google Cloud hosting, security, and SEO—plus Google
              Business Profile attention, review support, and one meaningful growth asset each
              month.
            </p>
            <ul className={PILLAR_LIST_GROWTH}>
              <li>Hosting on a fast global CDN—included in the plan</li>
              <li>Local SEO structure maintained as Google and your market shift</li>
        ...
        <p className={NOTE}>
          Limited to {FOUNDING_PARTNER_BUILD_SLOTS} approved partners. Fit and scope confirmed on a
          short call. Complimentary build applies when you enroll in the{" "}
          {FOUNDING_PARTNER_SEO_MONTHLY}/month {FOUNDING_PARTNER_SEO_LABEL}; terms reviewed before
          any commitment.
        </p>
      </div>
    </section>

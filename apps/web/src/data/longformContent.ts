...
const serviceFoundation: LongformSection[] = [
  {
    heading: "Strategy before design: how real service businesses win online",
    paragraphs: [
  ...
  {
    heading: "Technical execution that protects speed, trust, and rankings",
    paragraphs: [
  ...
  {
    heading: "Conversion architecture: from first click to booked conversation",
    paragraphs: [
  ...
  {
    heading: "Local SEO alignment: website, profile, and geography working together",
    paragraphs: [
  ...
  {
    heading: "Operations-ready content: made to be updated without breaking",
    paragraphs: [
  ...
  {
    heading: "What this means in practice for your next 90 days",
    paragraphs: [
  ...
  {
    heading: "Authority and proof: building trust signals that survive comparison",
    paragraphs: [
  ...
  {
    heading: "Scalable growth path: expanding pages without diluting quality",
    paragraphs: [
...
const blogExpansion: LongformSection[] = [
  {
    heading: "Operational context: why this topic matters in real lead generation",
    paragraphs: [
  ...
  {
    heading: "Execution framework: how to turn guidance into page-level changes",
    paragraphs: [
  ...
  {
    heading: "Content depth standards that avoid thin-page penalties",
    paragraphs: [
  ...
  {
    heading: "Local relevance: translating broad advice into market-specific actions",
    paragraphs: [
  ...
  {
    heading: "Measurement cadence: what to review weekly and monthly",
    paragraphs: [
  ...
  {
    heading: "Risk controls: preserving trust while scaling output",
    paragraphs: [
  ...
  {
    heading: "Team enablement: making this sustainable beyond one launch cycle",
    paragraphs: [
  ...
  {
    heading: "Implementation checklist: immediate actions after reading",
    paragraphs: [
...
const universalDepthAddendum: LongformSection[] = [
  {
    heading: "Decision support: questions buyers ask before they contact you",
    paragraphs: [
  ...
  {
    heading: "Implementation depth: how these standards improve mobile-first performance",
    paragraphs: [
  ...
  {
    heading: "Commercial outcomes: connecting page quality to pipeline quality",
    paragraphs: [
 ...
 */
export function getServiceLongformSections(serviceName: string): LongformSection[] {
  const base = serviceFoundation.map((section) => ({
    heading: `${section.heading} — ${serviceName}`,
    paragraphs: section.paragraphs,
  }));

  const depth = universalDepthAddendum.map((section) => ({
    heading: `${section.heading} — ${serviceName}`,
    paragraphs: section.paragraphs,
  }));
...
export function getServiceDetailLongformSections(serviceName: string): LongformSection[] {
...
export function getServiceAreaLongformSections(areaName: string): LongformSection[] {
  const base = serviceFoundation.map((section) => ({
...
export function getServiceAreaDetailLongformSections(areaName: string): LongformSection[] {
  return universalDepthAddendum.map((section) => ({
    heading: `${section.heading} — ${areaName}`,
    paragraphs: section.paragraphs,
  }));
...
export function getBlogLongformSections(postTitle: string): LongformSection[] {
  const base = blogExpansion.map((section) => ({
    heading: `${section.heading} — ${postTitle}`,
    paragraphs: section.paragraphs,
  }));

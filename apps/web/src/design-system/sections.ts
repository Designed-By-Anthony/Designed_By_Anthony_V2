...
export const SECTION_SHELL_PREMIUM_PITCH = "relative py-0 px-[var(--container-gutter)]";

export const SECTION_CONTAINER = "w-[min(var(--content-max),100%)] max-w-full mx-auto";

export const SECTION_HEADER = "max-w-[720px] mb-[clamp(2.35rem,4.5vw,3.35rem)] grid gap-[1.05rem]";
...
export const CARD_HAS_TEXT_PAD = "p-[max(var(--card-pad),var(--radius-card-lg))]";
export const CARD_LG_TEXT_PAD = "p-[max(var(--card-pad-lg),var(--radius-card-lg))]";

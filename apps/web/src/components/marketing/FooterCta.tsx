...
const CARD =
	"reveal-up p-[clamp(2rem,4vw,2.8rem)] rounded-[1.7rem] text-left grid grid-cols-1 md:[grid-template-columns:minmax(0,1.2fr)_minmax(240px,0.8fr)] gap-[clamp(1.2rem,2.6vw,2rem)] items-center bg-brand-surface border border-brand-border shadow-[0_24px_60px_-40px_rgba(26,42,64,0.12)] max-md:p-[1.8rem_1.25rem] max-md:rounded-[1.35rem] max-md:text-center [&>div>h2]:text-[clamp(1.95rem,4vw,3rem)] [&>div>h2]:font-extrabold [&>div>h2]:tracking-[-0.045em] [&>div>h2]:leading-[1.06] [&>div>h2]:text-brand-indigo [&>div>h2]:mb-[0.95rem] [&>div>p]:text-brand-charcoal [&>div>p]:text-[clamp(1rem,1.7vw,1.08rem)] [&>div>p]:leading-[1.72] [&>div>p]:opacity-[0.85] [&>div>p]:m-0 max-md:[&>div>p]:mx-auto";

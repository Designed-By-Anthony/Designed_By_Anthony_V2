  ...
  window.gtag('consent', 'update', {
    ...
    ad_personalization: 'denied',
      ...
      >
        <button
          type="button"
          className="pointer-events-auto inline-flex items-center justify-center gap-[0.45rem] py-[0.9rem] px-[1.4rem] [writing-mode:vertical-rl] [text-orientation:mixed] border border-r-0 border-brand-accent rounded-l-[0.85rem] bg-brand-accent text-brand-linen text-[0.88rem] font-extrabold tracking-[0.1em] uppercase font-[family-name:var(--font-display)] cursor-pointer shadow-[-6px_0_24px_rgba(26,42,64,0.22)] transition-[background,box-shadow,border-color,transform] duration-[250ms] ease-out hover:bg-brand-indigo hover:border-brand-indigo hover:-translate-x-[3px] hover:shadow-[-8px_0_28px_rgba(26,42,64,0.28)] active:-translate-x-[1px] focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-[rgb(var(--brand-accent-rgb)/0.45)] focus-visible:outline-offset-[3px] max-md:text-[0.78rem] max-md:py-[0.7rem] max-md:px-[1rem]"
          id="reachOutOpenBtn"
        ...
        <div className="rounded-2xl border border-brand-border bg-card shadow-[0_24px_48px_-28px_rgba(26,42,64,0.18)] px-[1.35rem] pt-[1.25rem] pb-[1.15rem] text-brand-charcoal">
          ...
          >
            {[
              ...
              return (
                <a key={action.label} href={action.href} className={className} data-reach-out-close>
                  {labelEl}
                  {detailEl}
                </a>
              );

...
import { getServiceAreaLocation, serviceAreaLocations } from "@/data/serviceAreaLocations";
import { staticMarketingPageCopy } from "@/data/staticMarketingPages";
import { btnOutline, btnPrimary, btnSecondaryProof, stackBadge } from "@/design-system/buttons";
import {
...
function MarketingBreadcrumbs({ items }: { items: BreadcrumbItem[] }) {
  ...
  return (
    <nav className="bg-white/[0.02] border-b border-white/[0.05] py-3" aria-label="Breadcrumb">
  ...
  return (
    <MarketingChrome footerCta={homeFooterCta}>
      ...
      <section className="section-shell">
        <MotionReveal className="section-container marketing-prose" y={16} duration={0.6}>
          <p className="reveal-up">
            Anthony builds custom websites, local SEO programs, managed hosting, and website rescues
            for contractors, home-service pros, medspas, salons, and other small businesses across
            Utica, Rome, Syracuse, and greater CNY.
          </p>
          <p className="reveal-up">
            You work directly with the person writing the code — no bait-and-switch account team, no
            offshore ticket queue.
          </p>
        </MotionReveal>
      </section>
      <section className="section-shell section-shell--wash">
        <div className="section-container">
          ...
          <MotionReveal className="section-header centered" y={24} duration={0.7}>
            <p className="section-eyebrow">How we work</p>
            <h2>Values that shape every project.</h2>
          </MotionReveal>
          <MotionStagger className="values-grid" staggerDelay={0.08}>
            <MotionStaggerChild as="article" className="surface-card value-card reveal-left">
              <div className="value-card-icon" aria-hidden="true">
                ⚡
              </div>
              <h3>Speed is respect</h3>
              <p>
                Fast pages respect your visitors' time. Every build ships mobile-first,
                performance-tuned, and scored against Google's own report card before launch.
              </p>
            </MotionStaggerChild>
            <MotionStaggerChild as="article" className="surface-card value-card reveal-up">
              <div className="value-card-icon" aria-hidden="true">
                🎯
              </div>
              <h3>One builder, end to end</h3>
              <p>
                Strategy, design, code, SEO, and support — one person accountable for the entire
                project. No handoff chain, no mystery subcontractors.
              </p>
            </MotionStaggerChild>
            <MotionStaggerChild as="article" className="surface-card value-card reveal-right">
              <div className="value-card-icon" aria-hidden="true">
                🛡️
              </div>
              <h3>Veteran discipline</h3>
              <p>
                Marine Corps–trained attention to detail. Deadlines are commitments, communication
                is direct, and nothing ships until it meets the standard.
              </p>
            </MotionStaggerChild>
            <MotionStaggerChild as="article" className="surface-card value-card reveal-up">
              <div className="value-card-icon" aria-hidden="true">
              ...
              <p>
                When you pay for a site, you own it — source code, assets, all of it. No hostage
                fees, no takedowns. The monthly plan is for SEO and hosting, not for keeping your
                site alive.
              </p>
            </MotionStaggerChild>
          </MotionStagger>
  ...
  return (
    <MarketingChrome footerCta={homeFooterCta}>
      ...
      <section className="section-shell">
        <MotionReveal className="section-container marketing-prose" y={16} duration={0.6}>
          <p className="reveal-up">
            {PUBLIC_STANDARD_PAYMENT_PLAN} {PUBLIC_LAUNCH_BUNDLE_COPY} When the build is done, you
            own the source code — no lock-in, no takedown if you leave. Book a short intro call for
            a written estimate tailored to your pages, integrations, and SEO depth.
          </p>
        </MotionReveal>
      </section>
      <section className="section-shell section-shell--wash">
          ...
          <MotionStagger className="pricing-tiers" staggerDelay={0.08}>
            ...
            >
              ...
              <p className="pricing-tier-desc">
                Single-service landing pages and simple brochure sites for local businesses starting
                out or testing a market.
              </p>
            ...
            >
              ...
              <p className="pricing-tier-desc">
                Full custom site for service businesses ready to rank locally and convert visitors
                into calls. 5–10 pages, custom design, and technical SEO — plus three months on us
                for hosting, security, and core local SEO before the monthly Growth Plan.
              </p>
              <ul className="pricing-tier-features">
            ...
            >
              ...
              <p className="pricing-tier-desc">
                Multi-location, integration-heavy, or franchise scope — CRM, booking, and advanced
                SEO across service areas.
              </p>
              <ul className="pricing-tier-features">
      ...
      <section className="section-shell">
        <div className="section-container">
          ...
          <MotionReveal className="section-header centered" y={24} duration={0.7}>
            ...
            <p>
              {FOUNDING_PARTNER_BUILD_SLOTS} founding partner spots pair a complimentary custom
              build with the {FOUNDING_PARTNER_SEO_MONTHLY}
              /mo {FOUNDING_PARTNER_SEO_LABEL} — hosting, security, and SEO included.
            </p>
          </MotionReveal>
          <MotionReveal
  ...
  return (
    <MarketingChrome footerCta={homeFooterCta}>
      ...
      <section className="section-shell">
        <MotionReveal className="section-container marketing-prose" y={16} duration={0.6}>
          <p className="reveal-up">
            We build lean, fast marketing sites with modern tooling so you are not fighting plugins,
            template drift, or mystery bloat six months after launch.
          </p>
        </MotionReveal>
      </section>
      <section className="section-shell section-shell--wash">
        <div className="section-container">
          ...
          <MotionReveal className="section-header centered" y={24} duration={0.7}>
            ...
            <p>The difference shows up in speed, search placement, and what breaks next month.</p>
          </MotionReveal>
          <MotionStagger className="comparison-grid" staggerDelay={0.08}>
            <MotionStaggerChild className="surface-card comparison-column comparison-column--them reveal-left">
              ...
              <ul className="comparison-list">
                ...
                <li>Agency keeps the code — site vanishes if you stop paying</li>
              </ul>
            </MotionStaggerChild>
      ...
      <section className="section-shell section-shell--wash">
        <div className="section-container">
          ...
          <MotionReveal className="section-header centered" y={24} duration={0.7}>
            <h2>The stack.</h2>
            <p>
              Modern tooling chosen for speed, stability, and longevity — not defaults inherited
              from a template.
            </p>
          </MotionReveal>
...
export function FaqPage() {
  ...
  return (
    <MarketingChrome footerCta={homeFooterCta}>
      ...
      />
      <PageHero kind="faq" title="FAQ" subtitle="Quick answers before you spend a dollar." />
      <section className="section-shell">
        <div className="section-container">
          <MotionStagger className="home-faq-list" staggerDelay={0.08} data-exclusive-details>
...
export function ServiceAreasPage() {
  ...
  const coreMarketCount = serviceAreaLocations.filter((r) => r.tag === "primary").length;
  const remoteMarketCount = serviceAreaLocations.filter((r) => r.tag === "secondary").length;
  ...
  return (
    <MarketingChrome footerCta={homeFooterCta}>
      ...
      <section className="section-shell">
        <MotionReveal className="section-container marketing-prose" y={16} duration={0.6}>
          <p className="reveal-up">
            Primary work is anchored in Rome, NY, with regular coverage across Utica, Syracuse, and
            the broader Mohawk Valley. We also support select remote clients on a case-by-case
            basis.
          </p>
        </MotionReveal>
      </section>
      <section className="section-shell section-shell--wash">
        <div className="section-container">
          <MotionStagger className="service-area-signal-strip reveal-up" staggerDelay={0.08}>
            <MotionStaggerChild className="surface-card service-area-signal">
              <span className="service-area-signal__label">Core Markets</span>
              <span className="service-area-signal__value">{coreMarketCount}</span>
            </MotionStaggerChild>
            <MotionStaggerChild className="surface-card service-area-signal">
              <span className="service-area-signal__label">Remote Markets</span>
              <span className="service-area-signal__value">{remoteMarketCount}</span>
            </MotionStaggerChild>
            <MotionStaggerChild className="surface-card service-area-signal">
              <span className="service-area-signal__label">Response Window</span>
            ...
            {serviceAreaLocations.map((r) => (
              <MotionStaggerChild as="div" key={r.slug}>
                ...
                >
                  ...
                  <h3>{r.name}</h3>
                  <p>{r.cardTeaser}</p>
                  <span className="region-card-more">Local web design guide →</span>
                </Link>
              </MotionStaggerChild>
            ))}
          </MotionStagger>
...
export function ServiceAreaLocationPage({ slug }: { slug: string }) {
  ...
  return (
    <MarketingChrome footerCta={homeFooterCta}>
      ...
      <section className="section-shell section-shell--wash">
        <div className="section-container">
          <MotionReveal className="local-context-chips reveal-up" y={20} duration={0.6}>
        ...
        <div className="section-container">
          ...
          <MotionReveal className="section-header centered" y={24} duration={0.7}>
            ...
            <p className="page-lead reveal-up">
              Each page explains how we approach web design and local SEO in that market — browse
              another city or <Link href="/service-areas">return to the full list</Link>.
            </p>
          </MotionReveal>
          <MotionStagger className="region-grid" staggerDelay={0.08}>
            {otherAreas.map((r) => (

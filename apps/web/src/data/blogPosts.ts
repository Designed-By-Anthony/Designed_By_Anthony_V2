...
export const blogPosts: BlogPostMeta[] = [
  {
    title: "Google Business Profile: The 2026 Playbook for CNY Service Businesses",
    excerpt:
  ...
  },
  {
    ...
    imageAlt: "Local SEO dashboard and search visibility visuals for a service business",
    imageWidth: 1024,
    imageHeight: 1024,

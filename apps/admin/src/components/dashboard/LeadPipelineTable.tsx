				...
				>
					<div className="max-w-md rounded-2xl border border-[rgba(26,42,64,0.12)] bg-[#f8f9fa] p-6 shadow-[0_24px_60px_-40px_rgba(26,42,64,0.35)]">
						...
						<p className="mt-3 text-[0.95rem] leading-relaxed text-brand-charcoal/85">
							...
							<span className="font-semibold text-brand-indigo">{company}</span> to
							an active client? This will grant them Zero Trust access and email them
							a login link.
						</p>
					...
					<tbody>
						{leads.length === 0 ? (
							<tr>
								<td
									colSpan={7}
									className={`${tdBase} py-8 text-center text-brand-charcoal/50`}
								>

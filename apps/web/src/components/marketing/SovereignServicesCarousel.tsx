...
export function SovereignServicesCarousel() {
  return (
    <section
      className="section-shell section-shell--wash mt-8 lg:mt-12"
      ...
      <div className="section-container">
        <div className="section-header max-w-[58rem]">
          ...
          <p className="mt-3 max-w-2xl text-[0.99rem] leading-7 text-slate-300">
            Swipe through the core offerings that power infrastructure-ready marketing sites and
            help service businesses win more calls.
          </p>
        </div>
          ...
          <div className="flex gap-5 min-w-[88%] lg:min-w-full px-1">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="mt-5 text-xl font-semibold text-brand-charcoal">{service.title}</h3>

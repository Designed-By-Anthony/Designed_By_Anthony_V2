    ...
    <main className="mx-auto max-w-7xl px-6 py-12">
      ...
      <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="rounded-xl border border-[rgba(26,42,64,0.1)] bg-[#f8f9fa] p-6 shadow-[0_6px_24px_-16px_rgba(26,42,64,0.15)]">
          <h3 className="mb-2 text-sm font-medium text-brand-charcoal/60">Total Leads</h3>
          <p className="text-3xl font-bold text-brand-indigo">{totalLeads}</p>
        </div>
        <div className="rounded-xl border border-[rgba(26,42,64,0.1)] bg-[#f8f9fa] p-6 shadow-[0_6px_24px_-16px_rgba(26,42,64,0.15)]">
          <h3 className="mb-2 text-sm font-medium text-brand-charcoal/60">Conversion Rate</h3>
        ...
        <div className="rounded-xl border border-[rgba(26,42,64,0.1)] bg-[#f8f9fa] p-6 shadow-[0_6px_24px_-16px_rgba(26,42,64,0.15)]">
          <h3 className="mb-2 text-sm font-medium text-brand-charcoal/60">Revenue Projection</h3>
          <p className="text-3xl font-bold text-brand-indigo">{revenueProjection}</p>
        </div>
      </div>

      <LeadPipelineTable leads={leads} error={error} promoteLead={promoteLeadToVault} />
    </main>
  );
}
